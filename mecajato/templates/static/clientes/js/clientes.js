...
function exibir_form(tipo){
    // adicionar cliente e atualisar cliente 
...
function dados_cliente(){
    ...
    // criar um formulario e inserir o id_cliente
    data = new FormData()
    data.append('id_cliente', id_cliente)

    // fetch para fazer requisições e depois tratar a resposta
    fetch("/clientes/atualiza_cliente/",{
        ...
        return result.json()
        // a função abaixo irá processar o result.json() da linha acima
    }).then(function(data){
...
function update_cliente(){
    ...
    fetch('/clientes/update_cliente/' + id, {
        ...
        // outra forma de enviar os dado para o backend
        body: JSON.stringify({
            nome: nome,
            sobrenome: sobrenome,
            email: email,
